...
const Footer = () => {
  return (
    <>
      <footer className="bg-[#1F2023] lg:pt-16" aria-labelledby="footer-heading">
          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-[#DDF166] py-2 px-4 text-base font-normal text-black hover:bg-[#BACB5A] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800"
                >
                  Subscribe
                </button>
              </div>
