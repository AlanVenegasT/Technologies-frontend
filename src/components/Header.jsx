...
const resources = [
  ...
  { name: 'Nuestros colaboradores', description: 'Learn how to maximize our platform to get the most out of it.', href: '#' },
  { name: 'Linea del tiempo ', description: 'See what meet-ups and other events we might be planning near you.', href: '#' },
  { name: 'Miembros', description: 'Understand how we take your privacy seriously.', href: '#' },
]
    ...
    <Popover className=" bg-gradient-to-r fixed w-full z-50 from-[#E990FF] via-[#B29DF9] to-[#83AEFB] shadow-2xl px-0 py-0  md:py-0 md:px-0 lg:px-0 lg:py-0">
      <div className="flex items-center justify-between px-6 py-5 md:justify-start md:space-x-10">
            ...
            {({ open }) => (
              <>
                ...
                >
                  ...
                  <ChevronDownIcon
                    className={classNames(
                      open ? 'text-gray-600' : 'text-[#1F2023]',
        ...
        <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
          <a href="#" className="whitespace-nowrap text-base font-medium text-[#1F2023] hover:text-white">
            Bienvenido
          </a>
