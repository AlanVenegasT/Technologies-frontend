...
export default function Testimoniales() {
    return (
        ...
        <>
            <h2 className='text-6xl lg:px-40 lg:py-12 bg-[#1F2023] text-white font-semibold'>Más de 180,000 estudiantes nos recomiendan en todo Latinoamérica</h2>
            <section className="bg-[#1F2023]">
                <div className="mx-auto max-w-7xl   md:grid md:grid-cols-2 md:px-6 lg:px-8  ">
                <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:border-r md:border-indigo-900 md:py-16 md:pl-0 md:pr-10 lg:pr-16 bg-[#2B2C32]">
