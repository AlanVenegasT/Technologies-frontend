...
import './Diseños/HeroD.css'

export default function HeroD() {
  return (
    <div className="bg-[#08121B]">
      <div className="mx-auto max-w-5xl py-16 px-4 text-center sm:py-16 sm:px-6 lg:px-4 ">
        <div className=''>
          <h3 className=' inline-flex w-full items-center justify-center rounded-md border border-white  bg-[#08121B] px-5 py-3 text-base font-medium text-[#DDDEDE] hover:bg-[#08121B] sm:w-auto'>
        ...
        <h2 className="text-3xl font-bold tracking-tight text-white sm:text-6xl lg:mt-14 ">
          ...
          <span className="block lg:mt-3">aprendizaje en línea y en vivo más</span>
          <span className="block lg:mt-3">grande de México y Latinoamérica</span>

        </h2>
        <p className="mt-4 text-2xl leading-8 text-indigo-200 lg:mt-12 lg:mr-10 lg:ml-10 ">
          A Clases en línea y en vivo dictadas por referentes de la industria, enfoque 100% práctico, mentorías personalizadas y acceso a una comunidad de +180,000 estudiantes.
        </p>
        <a
          href="#"
        ...
        <span className="block mt-4 text-lg leading-6 text-indigo-200">Conoce más...</span>

        <span className="block mt-28 text-lg leading-6 text-indigo-200">Nuestros programas están cocreados con expertos de</span>
      ...
      <h3 className='lg:ml-16 inline-flex w-full items-center justify-center border-b-2 border-[#0C4D8F] bg-[#08121B] px-96  py-3 text-base font-medium text-[#DDDEDE] hover:bg-[#08121B] sm:w-auto'>
        Accede a nuestra Charla informativa y conoce todo sobre Coderhouse 
      </h3>
      </div>
    </div>
