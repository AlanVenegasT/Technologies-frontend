      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid  grid-cols-2 gap-4">
          <div className="row-span-2 row-start-1 row-end-4  bg-[#27282D] rounded-md lg:mr-4 lg:ml-8  ">
            <h2 className="text-6xl  lg:ml-8 lg:mr-8 lg:mt-12  font-bold text-white leading-[72px] ">
              La mejor educacion en línea a tu alcance
            </h2>
            <h3 className="text-xl lg:ml-8 lg:mr-8 lg:mt-6 text-[#B3B3B3]">
          ...
          <div className=" row-span-2  bg-gradient-to-r from-[#EA92FD] via-[#EAC5B8] to-[#E6FA72] rounded-md lg:mt-16 lg:mr-4 lg:ml-8 ">
            <h2 className="text-4xl font-bold lg:ml-8 lg:mt-10 text-[#1F2023]">
              Tutores
            </h2>
            <h3 className="lg:ml-8 lg:mr-8 lg:mt-8 lg:mb-8 lg:text-xl text-[#1F2023]">
          ...
          <div className=" row-start-1 row-end-6 bg-[#27282D] rounded-md lg:mr-8 lg:ml-4">
        ...
        <div className="slide-track">
          ...
          <div className="slide">
            ...
            <div className="h-1/2">
              <h2 className="text-4xl font-bold lg:ml-8 lg:mt-10 text-white">
                Profesores expertos
              </h2>
              <h3 className="text-xl lg:ml-8 lg:mr-8 lg:mt-6 text-[#B3B3B3]">
